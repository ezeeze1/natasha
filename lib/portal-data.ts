...
export const SENATOR_PROFILE = {
  ...
  almaMater: ['University of Abuja (LL.B)', 'Nigerian Law School', 'University of Dundee, Scotland (LL.M)'],
...
export const BIO_MILESTONES: BioMilestone[] = [
  ...
  },
  {
    ...
    description: 'Earned LL.B from University of Abuja, called to Nigerian Bar, and completed Master of Laws (LL.M) at University of Dundee.',
    ...
    location: 'Abuja & Dundee, Scotland',
  },
  {
    id: 'bio-3',
    year: '2015 - 2018',
...
export const CONSTITUENCY_PROJECTS: ConstituencyProject[] = [
  ...
  // --- Researched 2024 Records ---
  {
    id: 'natasha-2024-scholarship',
    title: 'Kogi Central Tertiary Scholarship Scheme',
    lga: 'District Wide',
    sector: 'Education',
    status: 'Ongoing',
    progressPercentage: 50,
    year: 2024,
    completionDate: 'Launched 2024',
    description: 'A tertiary education support initiative reported as a scholarship programme for students from Kogi Central.',
    impactMetric: 'Tertiary education support for eligible students.',
    source: 'Radio Kogi / project communications',
  },
  {
    id: 'natasha-2024-osara-schools',
    title: 'Osara/Abobo Community Primary & Secondary Schools',
    lga: 'Adavi',
    sector: 'Education',
    status: 'Ongoing',
    progressPercentage: 50,
    year: 2024,
    completionDate: 'Flagged off 2024',
    description: 'Construction of primary and secondary school facilities serving the Osara/Abobo community.',
    impactMetric: 'Improved access to formal education infrastructure for the community.',
    source: 'Vanguard / Independent',
  },
  {
    id: 'natasha-2024-osara-health-water',
    title: 'Osara Community Health & Water Intervention',
    lga: 'Adavi',
    sector: 'Healthcare',
    status: 'Ongoing',
    progressPercentage: 50,
    year: 2024,
    completionDate: 'Project intervention 2024',
    description: 'Project-history reporting associates the Osara intervention with community health and water infrastructure.',
    impactMetric: 'Improved access to community health and basic infrastructure.',
    source: 'Project-history / project communications',
  },
  {
    id: 'natasha-2024-water-reticulation',
    title: 'Solar-Powered Water Reticulation Projects',
    lga: 'District Wide',
    sector: 'Water & Sanitation',
    status: 'Completed',
    progressPercentage: 100,
    year: 2024,
    completionDate: 'Commissioned 2024',
    description: 'Solar-powered water infrastructure developed to improve access to reliable water in communities across Kogi Central.',
    impactMetric: 'Improved community access to water.',
    source: 'Nigerian Tribune / project communications',
  },
  {
    id: 'natasha-2024-solar-streetlights',
    title: 'Solar-Powered Streetlight Programme',
    lga: 'District Wide',
    sector: 'Power & Energy',
    status: 'Completed',
    progressPercentage: 100,
    year: 2024,
    completionDate: 'Installed / commissioned 2024',
    description: 'Solar-powered streetlighting deployed across communities and road corridors in Kogi Central.',
    impactMetric: 'Improved nighttime visibility and community safety.',
    source: 'Project communications / public reporting',
  },
  // --- Researched 2025 Records ---
  {
    id: 'natasha-2025-ihima-market',
    title: 'Ihima Smart Market',
    lga: 'Okehi',
    sector: 'Roads & Infrastructure',
    status: 'Ongoing',
    progressPercentage: 50,
    year: 2025,
    completionDate: 'Flagged off 2025',
    description: 'A modern smart-market development intended to improve commercial infrastructure and provide improved trading facilities.',
    impactMetric: 'Improved commercial infrastructure for traders.',
    source: 'Daily Trust / project reporting',
  },
  {
    id: 'natasha-2025-okene-market',
    title: 'Okene Smart Market',
    lga: 'Okene',
    sector: 'Roads & Infrastructure',
    status: 'Ongoing',
    progressPercentage: 50,
    year: 2025,
    completionDate: 'Flagged off 2025',
    description: 'Modern market infrastructure designed to improve the trading environment and support local commerce.',
    impactMetric: 'Improved facilities for local commerce and traders.',
    source: 'Daily Trust / project reporting',
  },
  {
    id: 'natasha-2025-ganaja-water',
    title: 'Ganaja 50,000-Litre Solar Water Reticulation Project',
    lga: 'Ajaokuta',
    sector: 'Water & Sanitation',
    status: 'Completed',
    progressPercentage: 100,
    year: 2025,
    completionDate: 'Commissioned 2025',
    description: 'A 50,000-litre solar-powered water reticulation system commissioned in Ganaja.',
    impactMetric: '50,000-litre solar-powered water infrastructure.',
    source: 'Vanguard',
  },
  {
    id: 'natasha-2025-okene-borehole',
    title: 'Okene 20,000-Litre Borehole Project',
    lga: 'Okene',
    sector: 'Water & Sanitation',
    status: 'Completed',
    progressPercentage: 100,
    year: 2025,
    completionDate: 'Commissioned 2025',
    description: 'A 20,000-litre-capacity borehole project commissioned in Okene.',
    impactMetric: '20,000-litre water infrastructure capacity.',
    source: 'Vanguard / public reporting',
  },
  {
    id: 'natasha-2025-okaito-water',
    title: 'Okaito 50,000-Litre Solar Water Project',
    lga: 'District Wide',
    sector: 'Water & Sanitation',
    status: 'Completed',
    progressPercentage: 100,
    year: 2025,
    completionDate: 'Commissioned 2025',
    description: 'A 50,000-litre solar-powered water-reticulation project serving the Okaito community.',
    impactMetric: '50,000-litre solar-powered water infrastructure.',
    source: 'Vanguard / public reporting',
  },
  {
    id: 'natasha-2025-smart-streetlights',
    title: 'Community Smart Solar Streetlights',
    lga: 'District Wide',
    sector: 'Power & Energy',
    status: 'Completed',
    progressPercentage: 100,
    year: 2025,
    completionDate: 'Commissioned / installed 2025',
    description: 'Solar-powered smart streetlights deployed in Obangede, Eika, Kuroko and other Kogi Central communities.',
    impactMetric: 'Improved nighttime visibility and public-space lighting.',
    source: 'Vanguard / public reporting',
  },
  {
    id: 'natasha-2025-40-water-projects',
    title: '40 Solar-Powered Water Projects Programme',
    lga: 'District Wide',
    sector: 'Water & Sanitation',
    status: 'Completed',
    progressPercentage: 100,
    year: 2025,
    completionDate: 'Reported as executed 2025',
    description: 'Project reporting stated that 40 solar-powered water projects had been executed across communities in Kogi Central.',
    impactMetric: '40 solar-powered water projects reported across Kogi Central.',
    source: 'Vanguard',
  },
  {
    id: 'natasha-2025-osara-model-schools',
    title: 'Osara/Abobo Model Schools',
    lga: 'Adavi',
    sector: 'Education',
    status: 'Completed',
    progressPercentage: 100,
    year: 2025,
    completionDate: 'Commissioned 2025',
    description: 'Primary and secondary school facilities developed for the Osara/Abobo community.',
    impactMetric: 'Improved education infrastructure for the community.',
    source: 'Vanguard / public reporting',
  },
  {
    id: 'natasha-2025-green-mobility',
    title: 'Green Mobility Electric Vehicle Empowerment Programme',
    lga: 'District Wide',
    sector: 'Empowerment',
    status: 'Ongoing',
    progressPercentage: 50,
    year: 2025,
    completionDate: 'Launched 2025',
    description: 'An empowerment programme involving locally assembled electric vehicles intended to support constituents, including women, farmers and small-business operators.',
    impactMetric: 'Green mobility and livelihood-support opportunities.',
    source: 'THISDAY / Kogi project reporting',
  },
  {
    id: 'natasha-2025-trade-tools',
    title: 'Career & Trade Tools Empowerment Programme',
    lga: 'District Wide',
    sector: 'Empowerment',
    status: 'Ongoing',
    progressPercentage: 50,
    year: 2025,
    completionDate: 'Empowerment programme 2025',
    description: 'An empowerment programme involving livelihood and trade-support equipment, including tools associated with sewing, farming, processing and other small-business activities.',
    impactMetric: 'Livelihood and small-business support.',
    source: 'Project communications',
  },
  {
    id: 'natasha-2025-ihima-maternity',
    title: 'Ihima Maternity & Child Care Centre',
    lga: 'Okehi',
    sector: 'Healthcare',
    status: 'Completed',
    progressPercentage: 100,
    year: 2025,
    completionDate: 'Commissioned 2025',
    description: 'A maternity and child-care facility developed to support maternal and child healthcare.',
    impactMetric: 'Maternal and child healthcare infrastructure.',
    source: 'The Sun / Arise / THISDAY',
  },
  {
    id: 'natasha-2025-fgc-idoani',
    title: 'FGC Idoani Legacy Projects',
    lga: 'District Wide',
    sector: 'Education',
    status: 'Approved / In Procurement',
    progressPercentage: 0,
    year: 2025,
    completionDate: 'Announced 2025; completion targeted 2026',
    description: 'Legacy infrastructure announced for Federal Government College Idoani, including a 2,000-seat auditorium, 500-seat multipurpose hall, 10 staff quarters, 300 solar-powered streetlights and a 50,000-litre solar-powered water system.',
    impactMetric: 'Major education and campus infrastructure investment.',
    source: 'Punch / Guardian',
  },
  // --- Researched 2026 Records ---
  {
    id: 'natasha-2026-green-mobility-training',
    title: '100-Person Green Mobility Technical Training',
    lga: 'District Wide',
    sector: 'Empowerment',
    status: 'Ongoing',
    progressPercentage: 50,
    year: 2026,
    completionDate: 'Training / implementation 2026',
    description: 'Technical and operational training associated with electric and solar-powered mobility solutions for beneficiaries in Kogi Central.',
    impactMetric: 'Technical skills development in emerging green mobility technologies.',
    source: 'THISDAY / TheCable',
  },
  {
    id: 'natasha-2026-ev-handover',
    title: 'Electric Vehicle Empowerment – 100+ Beneficiaries',
    lga: 'District Wide',
    sector: 'Empowerment',
    status: 'Completed',
    progressPercentage: 100,
    year: 2026,
    completionDate: 'Presented / handed over 2026',
    description: 'More than 100 beneficiaries from the five LGAs were reported to have received electric vehicles following technical and operational training.',
    impactMetric: '100+ reported beneficiaries receiving electric mobility support.',
    source: 'The Guardian',
  },
  {
    id: 'natasha-2026-digital-access',
    title: 'Digital Access & Free Internet Service',
    lga: 'Okene',
    sector: 'Education',
    status: 'Completed',
    progressPercentage: 100,
    year: 2026,
    completionDate: 'Operational / deployed 2026',
    description: 'Free internet access initiatives aimed at improving digital connectivity and access to online educational resources.',
    impactMetric: 'Improved access to digital learning and internet connectivity.',
    source: 'Nigerian Tribune / Punch',
  },
  {
    id: 'natasha-2026-fce-wifi',
    title: 'FCE Okene Free Campus-Wide Wi-Fi',
    lga: 'Okene',
    sector: 'Education',
    status: 'Completed',
    progressPercentage: 100,
    year: 2026,
    completionDate: 'Deployed 2026',
    description: 'Free campus-wide Wi-Fi reported as installed to improve digital access for students and staff.',
    impactMetric: 'Campus-wide digital connectivity.',
    source: 'Punch / education reporting',
  },
  {
    id: 'natasha-2026-trees',
    title: '10,000 Economic Trees Initiative',
    lga: 'District Wide',
    sector: 'Empowerment',
    status: 'Ongoing',
    progressPercentage: 50,
    year: 2026,
    completionDate: 'Launched 2026',
    description: 'An initiative to plant 10,000 economic trees across Kogi Central, with reported objectives including environmental restoration, climate resilience, food security, biodiversity and sustainable livelihoods.',
    impactMetric: '10,000 economic trees targeted across Kogi Central.',
    source: 'THISDAY / TheCable / public reporting',
  },
];
